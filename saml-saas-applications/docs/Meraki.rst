...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Cisco Meraki:
...
Cisco Meraki Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Cisco Meraki, select Cisco Meraki and click :guilabel:`Add`.
...
To configure Cisco Meraki provide following inputs:
	- :guilabel:`User Role` : Provide the session variable identifying the user's role. This must match the Role defined in Meraki Administrator page.
	- :guilabel:`Dashboard Username` : Provide the session variable identifying the user in the dashboard.
