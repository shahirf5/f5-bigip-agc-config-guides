...
For example, to configure Cisco Meraki, select Cisco Meraki and click ``Add``.
...
#. Select the SAML SSO object created for for Cisco Meraki, and click ``Export Metadata``.
