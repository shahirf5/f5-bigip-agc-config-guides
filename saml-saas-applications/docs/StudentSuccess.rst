======================================================================================
SaaS Application Configuration Guide : StudentSuccess
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure StudentSuccess:
...
StudentSuccess Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure StudentSuccess, select StudentSuccess and click :guilabel:`Add`.
...
To configure StudentSuccess provide following inputs:
	- :guilabel:`University Identifier` : Provide the university identifier. For eg - If the SSO URI is https://studentsuccess.org/SSO/f5university, then the university identifier is f5university.
...
#. Select the SAML SSO object created for for StudentSuccess, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the StudentSuccess service.

Setup StudentSuccess as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to StudentSuccess documentation to set it up as SAML Service Provider.
