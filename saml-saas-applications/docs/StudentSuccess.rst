...
For example, to configure StudentSuccess, select StudentSuccess and click ``Add``.
...
To configure StudentSuccess provide following inputs:
	- ``University Identifier`` : Provide the university identifier. For eg - If the SSO URI is https://studentsuccess.org/SSO/f5university, then the university identifier is f5university.
...
#. Select the SAML SSO object created for for StudentSuccess, and click ``Export Metadata``.
