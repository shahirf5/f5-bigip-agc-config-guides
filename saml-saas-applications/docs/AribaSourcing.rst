...
For example, to configure Ariba Sourcing, select Ariba Sourcing and click :guilabel:`Add`.
...
To configure Ariba Sourcing provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain from your ACS URL. If the ACS URL is https://s1.ariba.com/Sourcing/Main/ad/samlAuth/SSOActions?realm=company, then company is the sub domain
...
#. Select the SAML SSO object created for for Ariba Sourcing, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Ariba Sourcing service.

Setup Ariba Sourcing as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Ariba Sourcing documentation to set it up as SAML Service Provider.
