...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure LivePerson:
...
LivePerson Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure LivePerson, select LivePerson and click :guilabel:`Add`.
...
LivePerson does not require any user input.
...
#. Select the SAML SSO object created for for LivePerson, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the LivePerson service.

Setup LivePerson as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to LivePerson documentation to set it up as SAML Service Provider.
