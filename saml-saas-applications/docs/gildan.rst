...
For example, to configure Gildan, select Gildan and click **Add**.
...
To configure Gildan provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - If the entity Id is https://company.gildan.com, then the sub domain is company.
...
#. Select the SAML SSO object created for for Gildan, and click **Export Metadata**.
