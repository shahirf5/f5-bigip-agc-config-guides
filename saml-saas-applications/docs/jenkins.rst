...
For example, to configure Jenkins, select Jenkins and click ``Add``.
...
To configure Jenkins provide following inputs:
	- ``Hostname`` : Enter your Hostname. For example, if your ACS URL is https://yourcompany.com/securityRealm/finishLogin, enter: yourcompany.com
...
#. Select the SAML SSO object created for for Jenkins, and click ``Export Metadata``.
