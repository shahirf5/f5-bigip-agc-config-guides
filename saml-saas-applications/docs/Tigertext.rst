...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Tigertext.me:
...
Tigertext.me Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Tigertext.me, select Tigertext.me and click :guilabel:`Add`.
...
To configure Tigertext.me provide following inputs:
	- :guilabel:`Organization ID` : Provide the organization ID. For eg - If the SSO URL is https://saml-lb.tigertext.me/v1/organization/abcdefgh01234/saml/consume, then organization id is abcdefgh01234.
...
#. Select the SAML SSO object created for for Tigertext.me, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Tigertext.me service.

Setup Tigertext.me as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Tigertext.me documentation to set it up as SAML Service Provider.
