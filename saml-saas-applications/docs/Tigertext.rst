...
For example, to configure Tigertext.me, select Tigertext.me and click **Add**.
...
#. Select the SAML SSO object created for for Tigertext.me, and click **Export Metadata**.
