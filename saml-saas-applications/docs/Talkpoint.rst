...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Talkpoint webcasts:
...
Talkpoint webcasts Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Talkpoint webcasts, select Talkpoint webcasts and click :guilabel:`Add`.
...
Talkpoint webcasts does not require any user input.
...
Refer to Talkpoint webcasts documentation to set it up as SAML Service Provider.
