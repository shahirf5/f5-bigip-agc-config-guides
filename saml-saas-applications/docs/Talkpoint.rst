...
For example, to configure Talkpoint webcasts, select Talkpoint webcasts and click **Add**.
...
#. Select the SAML SSO object created for for Talkpoint webcasts, and click **Export Metadata**.
