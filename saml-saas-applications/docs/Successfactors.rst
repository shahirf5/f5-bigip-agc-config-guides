...
For example, to configure SAP Successfactors, select SAP Successfactors and click :guilabel:`Add`.
...
To configure SAP Successfactors provide following inputs:
	- :guilabel:`Company ID` : Provide the company ID from the SSO URL. For eg- If the SSO URL is https://test.company.com/saml2/SAMLAssertionConsumer?company=testcompany, then company Id is testcompany.
	- :guilabel:`Domain Name` : Provide the domain name from the SSO URL. For eg- If the SSO URL is https://test.company.com/saml2/SAMLAssertionConsumer?company=testcompany, then domain name is test.company.com.
...
#. Select the SAML SSO object created for for SAP Successfactors, and click :guilabel:`Export Metadata`.
