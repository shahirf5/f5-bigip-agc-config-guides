...
For example, to configure Blackboard, select Blackboard and click **Add**.
...
To configure Blackboard provide following inputs:
	- **Sub Domain** : Provide your sub domain name. For eg - In https://company.blackboard.com/, sub domain is company
...
#. Select the SAML SSO object created for for Blackboard, and click **Export Metadata**.
