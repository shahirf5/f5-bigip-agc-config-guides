======================================================================================
SaaS Application Configuration Guide : Blackboard
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Blackboard:
...
Blackboard Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Blackboard, select Blackboard and click :guilabel:`Add`.
...
To configure Blackboard provide following inputs:
	- :guilabel:`Sub Domain` : Provide your sub domain name. For eg - In https://company.blackboard.com/, sub domain is company
...
#. Select the SAML SSO object created for for Blackboard, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Blackboard service.
