...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Zoom:
...
Zoom Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Zoom, select Zoom and click :guilabel:`Add`.
...
To configure Zoom provide following inputs:
	- :guilabel:`Sub Domain` : Provide your sub domain from your ZOOM URL. For eg - If URL is https://testcompany.zoom.us, then sub domain is testcompany.
...
Refer to Zoom documentation to set it up as SAML Service Provider.
