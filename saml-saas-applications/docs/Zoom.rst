=================================================================
SaaS Application Configuration Guide : Zoom
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Zoom:
...
Zoom Configuration in AGC Workflow
----------------------------------------------
...
To configure Zoom provide following inputs:
	- **Sub Domain** : Provide your sub domain from your ZOOM URL. For eg - If URL is https://testcompany.zoom.us, then sub domain is testcompany.
...
#. Identify the Saml SSO object created for for Zoom and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Zoom service.
