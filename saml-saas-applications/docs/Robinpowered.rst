...
For example, to configure Robinpowered, select Robinpowered and click ``Add``.
...
#. Select the SAML SSO object created for for Robinpowered, and click ``Export Metadata``.
