=================================================================
SaaS Application Configuration Guide : Datadog
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Datadog:
...
Datadog Configuration in AGC Workflow
----------------------------------------------
...
Datadog, select
Datadog and click on **Add** button
...
Datadog does not require any user input.
...
#. Identify the Saml SSO object created for for Datadog and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Datadog service.
