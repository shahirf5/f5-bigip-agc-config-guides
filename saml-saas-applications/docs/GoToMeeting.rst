...
For example, to configure Citrix GoToMeeting, select Citrix GoToMeeting and click ``Add``.
...
#. Select the SAML SSO object created for for Citrix GoToMeeting, and click ``Export Metadata``.
