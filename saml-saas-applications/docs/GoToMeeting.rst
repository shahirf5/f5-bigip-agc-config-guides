...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Citrix GoToMeeting:
...
Citrix GoToMeeting Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Citrix GoToMeeting, select Citrix GoToMeeting and click :guilabel:`Add`.
...
To configure Citrix GoToMeeting provide following inputs:
	- :guilabel:`Select your GoTo Product` : Select the GoTo Product.
...
Refer to Citrix GoToMeeting documentation to set it up as SAML Service Provider.
