======================================================================================
SaaS Application Configuration Guide : ExceedLMS (Intellum)
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure ExceedLMS (Intellum):
...
ExceedLMS (Intellum) Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure ExceedLMS (Intellum), select ExceedLMS (Intellum) and click :guilabel:`Add`.
...
To configure ExceedLMS (Intellum) provide following inputs:
	- :guilabel:`Environment` : Choose environment type. Environment type can be 'Production' or 'Staging'
	- :guilabel:`Sub Domain` : Enter your sub domain. For example, if your ACS URL is https://yourcompany.exceedlms.com/authentication/saml_login, enter: yourcompany
...
#. Select the SAML SSO object created for for ExceedLMS (Intellum), and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the ExceedLMS (Intellum) service.

Setup ExceedLMS (Intellum) as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to ExceedLMS (Intellum) documentation to set it up as SAML Service Provider.
