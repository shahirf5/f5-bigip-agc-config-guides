======================================================================================
SaaS Application Configuration Guide : Syncplicity
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Syncplicity:
...
Syncplicity Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Syncplicity, select Syncplicity and click :guilabel:`Add`.
...
To configure Syncplicity provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the SSO URL is https://company.syncplicity.com/Auth/AssertionConsumerService.aspx, then the sub domain is company.
...
#. Select the SAML SSO object created for for Syncplicity, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Syncplicity service.

Setup Syncplicity as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Syncplicity documentation to set it up as SAML Service Provider.
