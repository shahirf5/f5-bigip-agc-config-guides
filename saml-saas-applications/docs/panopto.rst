...
For example, to configure Panopto, select Panopto and click ``Add``.
...
To configure Panopto provide following inputs:
	- ``Panopto Server Name`` : Specify Panopto Server Name. Entity Id uses this value. If your ACS URL is https://serverName/panopto. then enter serverName.
...
#. Select the SAML SSO object created for for Panopto, and click ``Export Metadata``.
