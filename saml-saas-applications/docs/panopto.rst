======================================================================================
SaaS Application Configuration Guide : Panopto
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Panopto:
...
Panopto Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Panopto, select Panopto and click :guilabel:`Add`.
...
To configure Panopto provide following inputs:
	- :guilabel:`Panopto Server Name` : Specify Panopto Server Name. Entity Id uses this value. If your ACS URL is https://serverName/panopto. then enter serverName.
...
#. Select the SAML SSO object created for for Panopto, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Panopto service.

Setup Panopto as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Panopto documentation to set it up as SAML Service Provider.
