=================================================================
SaaS Application Configuration Guide : Signmesh
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Signmesh:
...
Signmesh Configuration in AGC Workflow
----------------------------------------------
...
Signmesh, select
Signmesh and click on **Add** button
...
To configure Signmesh provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - If the SSO URI is https://company.signmesh.com/public_html/simplesaml/module.php/saml/sp/metadata.php/default-sp, then the sub domain is company.
...
#. Identify the Saml SSO object created for for Signmesh and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Signmesh service.
