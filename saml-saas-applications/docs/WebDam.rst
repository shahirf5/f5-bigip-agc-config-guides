...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure WebDam:
...
WebDam Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure WebDam, select WebDam and click :guilabel:`Add`.
...
To configure WebDam provide following inputs:
	- :guilabel:`Sub Domain` : From your SSO URL like https://company.webdamdb.com/saml.php, the sub domain is company.
...
#. Select the SAML SSO object created for for WebDam, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the WebDam service.

Setup WebDam as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to WebDam documentation to set it up as SAML Service Provider.
