...
For example, to configure Qualys Guard, select Qualys Guard and click ``Add``.
...
#. Select the SAML SSO object created for for Qualys Guard, and click ``Export Metadata``.
