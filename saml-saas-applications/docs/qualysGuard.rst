...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Qualys Guard:
...
Qualys Guard Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Qualys Guard, select Qualys Guard and click :guilabel:`Add`.
...
To configure Qualys Guard provide following inputs:
	- :guilabel:`Qualys Guard Platform` : Select Qualys Guard Platform to configure ACS URI
...
#. Select the SAML SSO object created for for Qualys Guard, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Qualys Guard service.

Setup Qualys Guard as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Qualys Guard documentation to set it up as SAML Service Provider.
