...
For example, to configure Intelex, select Intelex and click **Add**.
...
To configure Intelex provide following inputs:
	- **Entity ID URL** : Specify the entity Id URL. ACS URL uses value of entity Id value. For example, entityId : https://clients.intelex.com sets up ACS URI value as https://clients.intelex.com/Login3/SAML2/Login.aspx
...
#. Select the SAML SSO object created for for Intelex, and click **Export Metadata**.
