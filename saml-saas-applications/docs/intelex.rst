======================================================================================
SaaS Application Configuration Guide : Intelex
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Intelex:
...
Intelex Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Intelex, select Intelex and click :guilabel:`Add`.
...
To configure Intelex provide following inputs:
	- :guilabel:`Entity ID URL` : Specify the entity Id URL. ACS URL uses value of entity Id value. For example, entityId : https://clients.intelex.com sets up ACS URI value as https://clients.intelex.com/Login3/SAML2/Login.aspx
...
#. Select the SAML SSO object created for for Intelex, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Intelex service.

Setup Intelex as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Intelex documentation to set it up as SAML Service Provider.
