...
To configure Intelex provide following inputs:
	- **Entity ID URL** : Specify the entityId URL which is used to setup ACS URI. For example, entityId : https://clients.intelex.com is used to setup ACS URI https://clients.intelex.com/Login3/SAML2/Login.aspx
