...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Ecitele:
...
Ecitele Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Ecitele, select Ecitele and click :guilabel:`Add`.
...
To configure Ecitele provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the entity Id is http://company.ecitele.com/, then the sub domain is company.
...
Refer to Ecitele documentation to set it up as SAML Service Provider.
