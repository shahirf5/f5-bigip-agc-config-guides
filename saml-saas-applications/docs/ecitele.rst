=================================================================
SaaS Application Configuration Guide : ecitele
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure ecitele:
...
ecitele Configuration in AGC Workflow
----------------------------------------------
...
ecitele, select
ecitele and click on **Add** button
...
To configure ecitele provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - If the entity Id is http://company.ecitele.com/, then the sub domain is company.
...
#. Identify the Saml SSO object created for for ecitele and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in ecitele service.
