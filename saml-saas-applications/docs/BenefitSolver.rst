...
For example, to configure Benefit Solver, select Benefit Solver and click **Add**.
...
#. Select the SAML SSO object created for for Benefit Solver, and click **Export Metadata**.
