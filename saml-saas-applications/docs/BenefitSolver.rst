=================================================================
SaaS Application Configuration Guide : Benefit Solver
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Benefit Solver:
...
Benefit Solver Configuration in AGC Workflow
----------------------------------------------
...
Benefit Solver, select
Benefit Solver and click on **Add** button
...
To configure Benefit Solver provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - If the SSO URL is https://$subDomain$.benefitsolver.com/saml20/, then the sub domain is company.
...
#. Identify the Saml SSO object created for for Benefit Solver and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Benefit Solver service.
