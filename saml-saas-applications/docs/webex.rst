======================================================================================
SaaS Application Configuration Guide : WebEx
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure WebEx:
...
WebEx Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure WebEx, select WebEx and click :guilabel:`Add`.
...
To configure WebEx provide following inputs:
	- :guilabel:`Domain Specific Id` : Provide your domain specific id from the SSO URL. For eg - If the SSO URL is https://testid.webex.com/dispatcher/SAML2AuthService?siteurl=testid, then testid is the domain specific id.
...
#. Select the SAML SSO object created for for WebEx, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the WebEx service.

Setup WebEx as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to WebEx documentation to set it up as SAML Service Provider.
