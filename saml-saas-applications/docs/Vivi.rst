...
For example, to configure Vivi, select Vivi and click **Add**.
...
To configure Vivi provide following inputs:
	- **Unique Organization ID** : Provide your unique organization ID. For eg - If Entity ID is https://api.vivi.io/api/v1/users/saml_metadata/abcd-1234, then abcd-1234 is the unique id.
...
#. Select the SAML SSO object created for for Vivi, and click **Export Metadata**.
