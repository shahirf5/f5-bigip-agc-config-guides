...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Evidence:
...
Evidence Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Evidence, select Evidence and click :guilabel:`Add`.
...
To configure Evidence provide following inputs:
	- :guilabel:`Sub Domain` : Provide your sub domain. For eg - If your SSO URL is https://company.evidence.com, then the sub domain is company.
...
#. Select the SAML SSO object created for for Evidence, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Evidence service.

Setup Evidence as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Evidence documentation to set it up as SAML Service Provider.
