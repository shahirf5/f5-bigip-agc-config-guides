...
For example, to configure Brainstorm Quickhelp, select Brainstorm Quickhelp and click :guilabel:`Add`.
...
#. Select the SAML SSO object created for for Brainstorm Quickhelp, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Brainstorm Quickhelp service.

Setup Brainstorm Quickhelp as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Brainstorm Quickhelp documentation to set it up as SAML Service Provider.
