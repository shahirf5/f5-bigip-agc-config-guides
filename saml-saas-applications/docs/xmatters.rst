...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure xmatters:
...
xmatters Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure xmatters, select xmatters and click :guilabel:`Add`.
...
To configure xmatters provide following inputs:
	- :guilabel:`Sub Domain` : Enter Sub domain. For example in entity ID https://acme.xmatters.com, acme is the sub domain.
...
#. Select the SAML SSO object created for for xmatters, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the xmatters service.

Setup xmatters as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to xmatters documentation to set it up as SAML Service Provider.
