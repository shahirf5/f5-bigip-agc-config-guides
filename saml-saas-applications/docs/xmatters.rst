...
For example, to configure xmatters, select xmatters and click ``Add``.
...
To configure xmatters provide following inputs:
	- ``Sub Domain`` : Enter Sub domain. For example in entity ID https://acme.xmatters.com, acme is the sub domain.
...
#. Select the SAML SSO object created for for xmatters, and click ``Export Metadata``.
