...
For example, to configure Pagerduty, select Pagerduty and click **Add**.
...
To configure Pagerduty provide following inputs:
	- **Sub Domain** : Provide the sub domain from your SSO url. For eg if URL is https://company.pagerduty.com, then subDomain is company
...
#. Select the SAML SSO object created for for Pagerduty, and click **Export Metadata**.
