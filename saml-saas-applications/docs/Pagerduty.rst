======================================================================================
SaaS Application Configuration Guide : Pagerduty
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Pagerduty:
...
Pagerduty Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Pagerduty, select Pagerduty and click :guilabel:`Add`.
...
To configure Pagerduty provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain from your SSO url. For eg if URL is https://company.pagerduty.com, then subDomain is company
...
#. Select the SAML SSO object created for for Pagerduty, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Pagerduty service.

Setup Pagerduty as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Pagerduty documentation to set it up as SAML Service Provider.
