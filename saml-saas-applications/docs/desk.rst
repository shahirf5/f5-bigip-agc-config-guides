...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Desk:
...
Desk Configuration in AGC Workflow
----------------------------------------------
...
#. Identify the Saml SSO object created for for Desk and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Desk service.
