...
For example, to configure LinkedIn Learning, select LinkedIn Learning and click ``Add``.
...
To configure LinkedIn Learning provide following inputs:
	- ``Entity ID`` : Provide Entity ID URL from the metadata file.
...
#. Select the SAML SSO object created for for LinkedIn Learning, and click ``Export Metadata``.
