...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure LinkedIn Learning:
...
LinkedIn Learning Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure LinkedIn Learning, select LinkedIn Learning and click :guilabel:`Add`.
...
To configure LinkedIn Learning provide following inputs:
	- :guilabel:`Entity ID` : Provide Entity ID URL from the metadata file.
...
#. Select the SAML SSO object created for for LinkedIn Learning, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the LinkedIn Learning service.

Setup LinkedIn Learning as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to LinkedIn Learning documentation to set it up as SAML Service Provider.
