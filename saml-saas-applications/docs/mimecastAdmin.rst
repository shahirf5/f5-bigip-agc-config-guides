======================================================================================
SaaS Application Configuration Guide : Mimecast (Admin)
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Mimecast (Admin):
...
Mimecast (Admin) Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Mimecast (Admin), select Mimecast (Admin) and click :guilabel:`Add`.
...
To configure Mimecast (Admin) provide following inputs:
	- :guilabel:`Account Code` : ACCOUNTCODE is your unique Mimecast account code as specified in the Administration | Account | Account Settings page of the Administration Console
	- :guilabel:`Region` : Select the region of Mimecast grid that hosts your organization's Mimecast account.
...
#. Select the SAML SSO object created for for Mimecast (Admin), and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Mimecast (Admin) service.

Setup Mimecast (Admin) as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Mimecast (Admin) documentation to set it up as SAML Service Provider.
