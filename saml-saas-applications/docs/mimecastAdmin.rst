...
For example, to configure Mimecast (Admin), select Mimecast (Admin) and click **Add**.
...
#. Select the SAML SSO object created for for Mimecast (Admin), and click **Export Metadata**.
