...
For example, to configure ADP, select ADP and click **Add**.
...
To configure ADP provide following inputs:
	- **Person Immutable ID** : Provide the session variable which will map to the personimmutableID attribute. Assertion value include this value.
...
#. Select the SAML SSO object created for for ADP, and click **Export Metadata**.
