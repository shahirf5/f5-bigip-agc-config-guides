...
For example, to configure Bugcrowd, select Bugcrowd and click **Add**.
...
To configure Bugcrowd provide following inputs:
	- **Organization ID** : Provide the organization id.
...
#. Select the SAML SSO object created for for Bugcrowd, and click **Export Metadata**.
