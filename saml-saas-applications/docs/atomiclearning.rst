...
For example, to configure Atomic Learning, select Atomic Learning and click **Add**.
...
#. Select the SAML SSO object created for for Atomic Learning, and click **Export Metadata**.
