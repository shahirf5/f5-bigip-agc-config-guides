=================================================================
SaaS Application Configuration Guide : Atomic Learning
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Atomic Learning:
...
Atomic Learning Configuration in AGC Workflow
----------------------------------------------
...
Atomic Learning, select
Atomic Learning and click on **Add** button
...
Atomic Learning does not require any user input.
...
#. Identify the Saml SSO object created for for Atomic Learning and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Atomic Learning service.
