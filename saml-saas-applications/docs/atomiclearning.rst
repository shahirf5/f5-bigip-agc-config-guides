...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Atomic Learning:
...
Atomic Learning Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Atomic Learning, select Atomic Learning and click :guilabel:`Add`.
...
Refer to Atomic Learning documentation to set it up as SAML Service Provider.
