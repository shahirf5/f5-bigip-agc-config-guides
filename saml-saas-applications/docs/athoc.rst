...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure AtHoc Services:
...
AtHoc Services Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure AtHoc Services, select AtHoc Services and click :guilabel:`Add`.
...
AtHoc Services does not require any user input.
...
Refer to AtHoc Services documentation to set it up as SAML Service Provider.
