...
For example, to configure AtHoc Services, select AtHoc Services and click **Add**.
...
#. Select the SAML SSO object created for for AtHoc Services, and click **Export Metadata**.
