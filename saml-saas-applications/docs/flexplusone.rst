...
For example, to configure Flex PlusOne, select Flex PlusOne and click :guilabel:`Add`.
...
#. Select the SAML SSO object created for for Flex PlusOne, and click :guilabel:`Export Metadata`.
