...
For example, to configure Intrepid Learning, select Intrepid Learning and click **Add**.
...
#. Select the SAML SSO object created for for Intrepid Learning, and click **Export Metadata**.
