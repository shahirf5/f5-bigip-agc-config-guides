...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Intrepid Learning:
...
Intrepid Learning Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Intrepid Learning, select Intrepid Learning and click :guilabel:`Add`.
...
To configure Intrepid Learning provide following inputs:
	- :guilabel:`Sub Domain` : Provide your sub domain. For eg - If your SSO URL is https://company.intrepidagile.com/mlp/saml/acs, then the sub domain is company.
...
#. Select the SAML SSO object created for for Intrepid Learning, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Intrepid Learning service.

Setup Intrepid Learning as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Intrepid Learning documentation to set it up as SAML Service Provider.
