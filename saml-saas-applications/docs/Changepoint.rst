...
For example, to configure Changepoint, select Changepoint and click ``Add``.
...
To configure Changepoint provide following inputs:
	- ``Hostname`` : Enter Hostname. For example, if your ACS URL is https://changepoint.com/RP-STS_SAML/SAML/AssertionConsumerService.aspx, enter: changepoint.com
...
#. Select the SAML SSO object created for for Changepoint, and click ``Export Metadata``.
