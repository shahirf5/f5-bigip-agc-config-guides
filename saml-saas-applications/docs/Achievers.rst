======================================================================================
SaaS Application Configuration Guide : Achievers
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Achievers:
...
Achievers Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Achievers, select Achievers and click :guilabel:`Add`.
...
To configure Achievers provide following inputs:
	- :guilabel:`Domain Name` : Provide your company domain name. If the SSO URL is https://f5.achievers.com, enter f5
...
#. Select the SAML SSO object created for for Achievers, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Achievers service.

Setup Achievers as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Achievers documentation to set it up as SAML Service Provider.
