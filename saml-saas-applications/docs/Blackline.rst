...
For example, to configure Blackline, select Blackline and click :guilabel:`Add`.
...
#. Select the SAML SSO object created for for Blackline, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Blackline service.

Setup Blackline as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Blackline documentation to set it up as SAML Service Provider.
