...
For example, to configure Chronus, select Chronus and click ``Add``.
...
To configure Chronus provide following inputs:
	- ``Sub Domain`` : Specify Sub Domain. If ACS URI is https://acme.chronus.com/session then enter acme for Sub Domain
...
#. Select the SAML SSO object created for for Chronus, and click ``Export Metadata``.
