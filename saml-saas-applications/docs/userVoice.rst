...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure UserVoice:
...
UserVoice Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure UserVoice, select UserVoice and click :guilabel:`Add`.
...
To configure UserVoice provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the URL is company.uservoice.com, then the sub domain is company.
...
#. Select the SAML SSO object created for for UserVoice, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the UserVoice service.

Setup UserVoice as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to UserVoice documentation to set it up as SAML Service Provider.
