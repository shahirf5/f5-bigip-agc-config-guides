======================================================================================
SaaS Application Configuration Guide : Innotas
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Innotas:
...
Innotas Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Innotas, select Innotas and click :guilabel:`Add`.
...
To configure Innotas provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the ACS URL is https://company.innotas.com/login_sub.pa, then the sub domain is company.
...
#. Select the SAML SSO object created for for Innotas, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Innotas service.
