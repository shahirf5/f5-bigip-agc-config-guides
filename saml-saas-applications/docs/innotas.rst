...
For example, to configure Innotas, select Innotas and click **Add**.
...
To configure Innotas provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - If the ACS URL is https://company.innotas.com/login_sub.pa, then the sub domain is company.
...
#. Select the SAML SSO object created for for Innotas, and click **Export Metadata**.
