...
For example, to configure Promapp, select Promapp and click **Add**.
...
To configure Promapp provide following inputs:
	...
	- **Sub Domain** : Provide the sub domain. For eg if the SSO URL is https://company.promapp.com/xyz/, the sub domain is company.
...
#. Select the SAML SSO object created for for Promapp, and click **Export Metadata**.
