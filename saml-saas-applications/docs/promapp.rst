...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Promapp:
...
Promapp Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Promapp, select Promapp and click :guilabel:`Add`.
...
To configure Promapp provide following inputs:
	- :guilabel:`Tenant Name` : Provide the Tenant Name. For eg if the SSO URL is https://company.promapp.com/tenant/, the Tenant Name is tenant.
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg if the SSO URL is https://company.promapp.com/xyz/, the sub domain is company.
...
#. Select the SAML SSO object created for for Promapp, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Promapp service.

Setup Promapp as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Promapp documentation to set it up as SAML Service Provider.
