======================================================================================
SaaS Application Configuration Guide : CMO Compliance
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure CMO Compliance:
...
CMO Compliance Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure CMO Compliance, select CMO Compliance and click :guilabel:`Add`.
...
To configure CMO Compliance provide following inputs:
	- :guilabel:`Sub Domain` : Provide the Sub Domain. For e.g. if the Entity Id URL is http://company.cmo-compliance.com/adfs/services/trust, the Sub Domain is company
...
#. Select the SAML SSO object created for for CMO Compliance, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the CMO Compliance service.

Setup CMO Compliance as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to CMO Compliance documentation to set it up as SAML Service Provider.
