...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Akamai Enterprise Access:
...
Akamai Enterprise Access Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Akamai Enterprise Access, select Akamai Enterprise Access and click :guilabel:`Add`.
...
To configure Akamai Enterprise Access provide following inputs:
	- :guilabel:`Company Sub Domain` : Provide the Sub Domain. For eg if the SSO URL is https://company.login.go.akamai-access.com/saml/sp/response, the Sub Domain is company.
...
#. Select the SAML SSO object created for for Akamai Enterprise Access, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Akamai Enterprise Access service.

Setup Akamai Enterprise Access as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Akamai Enterprise Access documentation to set it up as SAML Service Provider.
