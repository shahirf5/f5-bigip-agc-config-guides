...
For example, to configure Akamai Enterprise Access, select Akamai Enterprise Access and click **Add**.
...
#. Select the SAML SSO object created for for Akamai Enterprise Access, and click **Export Metadata**.
