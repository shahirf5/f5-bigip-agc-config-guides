...
For example, to configure Lucidchart, select Lucidchart and click :guilabel:`Add`.
...
To configure Lucidchart provide following inputs:
	- :guilabel:`Domain` : Enter your Lucidchart account domain from the Domain field under the Lucidchart Sign in URL section in Lucidchart App Integration panel. Enter domain name only, not a full URL.
...
#. Select the SAML SSO object created for for Lucidchart, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Lucidchart service.

Setup Lucidchart as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Lucidchart documentation to set it up as SAML Service Provider.
