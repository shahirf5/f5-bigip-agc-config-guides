...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Oracle CRM onDemand:
...
Oracle CRM onDemand Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Oracle CRM onDemand, select Oracle CRM onDemand and click :guilabel:`Add`.
...
To configure Oracle CRM onDemand provide following inputs:
	- :guilabel:`Sub Domain` : Provide sub domain name For. eg - In https://my333036-sso.crm.ondemand.com, my333036-sso is the sub domain name
...
Refer to Oracle CRM onDemand documentation to set it up as SAML Service Provider.
