...
For example, to configure Oracle CRM onDemand, select Oracle CRM onDemand and click **Add**.
...
#. Select the SAML SSO object created for for Oracle CRM onDemand, and click **Export Metadata**.
