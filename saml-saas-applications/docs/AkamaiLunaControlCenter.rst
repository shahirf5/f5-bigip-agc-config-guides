...
For example, to configure Akamai Luna Control Center, select Akamai Luna Control Center and click **Add**.
...
#. Select the SAML SSO object created for for Akamai Luna Control Center, and click **Export Metadata**.
