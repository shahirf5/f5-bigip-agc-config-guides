...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Akamai Luna Control Center:
...
Akamai Luna Control Center Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Akamai Luna Control Center, select Akamai Luna Control Center and click :guilabel:`Add`.
...
To configure Akamai Luna Control Center provide following inputs:
	- :guilabel:`Company Sub Somain` : Provide your company sub domain. For eg if your SSO URL is https://company.luna-sp.com/sso/endpoint/postResponse then sub domain is company.
...
#. Select the SAML SSO object created for for Akamai Luna Control Center, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Akamai Luna Control Center service.

Setup Akamai Luna Control Center as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Akamai Luna Control Center documentation to set it up as SAML Service Provider.
