...
For example, to configure Planview, select Planview and click ``Add``.
...
To configure Planview provide following inputs:
	- ``Sub Domain`` : Specify sub domain. If Entity ID is https://acme.pvcloud.com/planview/, enter acme
...
#. Select the SAML SSO object created for for Planview, and click ``Export Metadata``.
