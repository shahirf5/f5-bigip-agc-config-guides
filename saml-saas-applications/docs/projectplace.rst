...
For example, to configure Projectplace, select Projectplace and click ``Add``.
...
#. Select the SAML SSO object created for for Projectplace, and click ``Export Metadata``.
