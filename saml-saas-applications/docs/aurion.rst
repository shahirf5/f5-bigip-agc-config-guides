======================================================================================
SaaS Application Configuration Guide : Aurion
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Aurion:
...
Aurion Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Aurion, select Aurion and click :guilabel:`Add`.
...
To configure Aurion provide following inputs:
	- :guilabel:`Callback URL` : Enter your Callback URL. For example, enter: https://AurionSelfService.acme.io/login/callback
	- :guilabel:`Issuer URL` : Enter your Issuer URL. For example, enter: https://AurionSelfService.acme.io
...
#. Select the SAML SSO object created for for Aurion, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Aurion service.
