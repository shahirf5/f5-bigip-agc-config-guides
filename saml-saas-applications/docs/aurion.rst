...
For example, to configure Aurion, select Aurion and click **Add**.
...
To configure Aurion provide following inputs:
	- **Callback URL** : Enter your Callback URL. For example, enter: https://AurionSelfService.acme.io/login/callback
	- **Issuer URL** : Enter your Issuer URL. For example, enter: https://AurionSelfService.acme.io
...
#. Select the SAML SSO object created for for Aurion, and click **Export Metadata**.
