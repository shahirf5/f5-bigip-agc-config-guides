...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Thirdlight:
...
Thirdlight Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Thirdlight, select Thirdlight and click :guilabel:`Add`.
...
To configure Thirdlight provide following inputs:
	- :guilabel:`Unique Company Identifier` : From the ACS URL, https://$subDomain$.thirdlight.com/samlconsume.tlx/1234567890/module.php/saml/sp/saml2-acs.php/samlauth, then the Unique Company Identifier is 1234567890
	- :guilabel:`Sub Domain` : If your SSO URL is http://company.thirdlight.com/saml/sp, then sub domain is company.
...
#. Select the SAML SSO object created for for Thirdlight, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Thirdlight service.

Setup Thirdlight as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Thirdlight documentation to set it up as SAML Service Provider.
