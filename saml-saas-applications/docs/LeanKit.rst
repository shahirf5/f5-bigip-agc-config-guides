...
For example, to configure LeanKit, select LeanKit and click **Add**.
...
To configure LeanKit provide following inputs:
	- **Sub Domain** : Provide the sub domain. For example, if the Entity ID is like https://company.leankit.com, sub domain is company
...
#. Select the SAML SSO object created for for LeanKit, and click **Export Metadata**.
