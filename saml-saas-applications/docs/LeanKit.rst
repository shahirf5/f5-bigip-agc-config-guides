...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure LeanKit:
...
LeanKit Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure LeanKit, select LeanKit and click :guilabel:`Add`.
...
To configure LeanKit provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For example, if the Entity ID is like https://company.leankit.com, sub domain is company
...
#. Select the SAML SSO object created for for LeanKit, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the LeanKit service.

Setup LeanKit as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to LeanKit documentation to set it up as SAML Service Provider.
