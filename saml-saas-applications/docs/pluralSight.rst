=================================================================
SaaS Application Configuration Guide : PluralSight (Production)
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure PluralSight (Production):
...
PluralSight (Production) Configuration in AGC Workflow
----------------------------------------------
...
PluralSight (Production), select
PluralSight (Production) and click on **Add** button
...
PluralSight (Production) does not require any user input.
...
#. Identify the Saml SSO object created for for PluralSight (Production) and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in PluralSight (Production) service.
