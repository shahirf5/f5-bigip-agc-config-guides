=================================================================
SaaS Application Configuration Guide : FactSet
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure FactSet:
...
FactSet Configuration in AGC Workflow
----------------------------------------------
...
FactSet, select
FactSet and click on **Add** button
...
FactSet does not require any user input.
...
#. Identify the Saml SSO object created for for FactSet and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in FactSet service.
