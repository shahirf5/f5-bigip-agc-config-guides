======================================================================================
SaaS Application Configuration Guide : Riskcloud
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Riskcloud:
...
Riskcloud Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Riskcloud, select Riskcloud and click :guilabel:`Add`.
...
To configure Riskcloud provide following inputs:
	- :guilabel:`Company Code` : Provide the company code. For eg - If the SSO URL is https://www.riskcloud.net/prod/saml.aspx?ccode=test, then company code is test.
...
#. Select the SAML SSO object created for for Riskcloud, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Riskcloud service.

Setup Riskcloud as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Riskcloud documentation to set it up as SAML Service Provider.
