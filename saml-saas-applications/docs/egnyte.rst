...
For example, to configure Egnyte, select Egnyte and click ``Add``.
...
To configure Egnyte provide following inputs:
	- ``Sub Domain`` : Enter sub domain. For example, if your ACS url is https://company.egnyte.com/samlconsumer/adfs, enter: company
...
#. Select the SAML SSO object created for for Egnyte, and click ``Export Metadata``.
