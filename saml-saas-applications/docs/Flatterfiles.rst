...
For example, to configure Flatterfiles, select Flatterfiles and click **Add**.
...
#. Select the SAML SSO object created for for Flatterfiles, and click **Export Metadata**.
