...
For example, to configure Community 360, select Community 360 and click :guilabel:`Add`.
...
To configure Community 360 provide following inputs:
	- :guilabel:`Sub Domain` : Enter your sub domain. For example, if your login URL is https://yourcompany.community360.net, enter: yourcompany
	- :guilabel:`Account Key` : Enter your account key. For example if your ACS URL is https://yourcompany.community360.net/sso.aspx?Accountkey=1234 enter: 1234
