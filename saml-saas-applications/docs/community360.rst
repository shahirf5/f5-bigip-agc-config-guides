...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Community 360:
...
Community 360 Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Community 360, select Community 360 and click **Add**.
...
#. Select the SAML SSO object created for for Community 360, and click **Export Metadata**.
