=================================================================
SaaS Application Configuration Guide : Community 360
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Community 360:
...
Community 360 Configuration in AGC Workflow
----------------------------------------------
...
Community 360, select
Community 360 and click on **Add** button
...
To configure Community 360 provide following inputs:
	- **Sub Domain** : Enter your sub domain. For example, if your login URL is https://yourcompany.community360.net, enter: yourcompany
	- **Account Key** : Enter your account key. For example if your ACS URL is https://yourcompany.community360.net/sso.aspx?Accountkey=1234 enter: 1234
...
#. Identify the Saml SSO object created for for Community 360 and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Community 360 service.
