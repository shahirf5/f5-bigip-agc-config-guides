...
For example, to configure Staples Easy Print, select Staples Easy Print and click ``Add``.
...
#. Select the SAML SSO object created for for Staples Easy Print, and click ``Export Metadata``.
