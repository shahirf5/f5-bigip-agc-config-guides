...
For example, to configure Voicestorm, select Voicestorm and click **Add**.
...
To configure Voicestorm provide following inputs:
	- **Sub Domain** : Specify sub domain. For example, if your ACS URL is https://acme.voicestorm.com/User/SsoResponse, then enter acme. Entity ID https://acme.voicestorm.com also uses sub domain.
...
#. Select the SAML SSO object created for for Voicestorm, and click **Export Metadata**.
