...
To configure voicestorm provide following inputs:
	- **Sud Domain** : Specify sub domain. For example, if your ACS URL is https://acme.voicestorm.com/User/SsoResponse, then enter acme. Entity ID https://acme.voicestorm.com also uses sub domain.
