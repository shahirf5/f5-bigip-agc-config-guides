...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Kenexa BrassRing(IBM):
...
Kenexa BrassRing(IBM) Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Kenexa BrassRing(IBM), select Kenexa BrassRing(IBM) and click ``Add``.
...
#. Select the SAML SSO object created for for Kenexa BrassRing(IBM), and click ``Export Metadata``.
