...
For example, to configure Kenexa BrassRing(IBM), select Kenexa BrassRing(IBM) and click :guilabel:`Add`.
...
To configure Kenexa BrassRing(IBM) provide following inputs:
	- :guilabel:`Sub Domain` : Enter your sub domain. For example, if your ACS URL is https://yourcompany.brassring.com/SSO/SAML/SAML2PageListener/AssertionConsumerService.aspx, enter: yourcompany
