...
For example, to configure Euromonitor, select Euromonitor and click **Add**.
...
To configure Euromonitor provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - If the SSO URL is https://company.euromonitor.com/sp/ACS.saml2, then the sub domain is company.
...
#. Select the SAML SSO object created for for Euromonitor, and click **Export Metadata**.
