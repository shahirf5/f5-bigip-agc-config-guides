======================================================================================
SaaS Application Configuration Guide : Euromonitor
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Euromonitor:
...
Euromonitor Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Euromonitor, select Euromonitor and click :guilabel:`Add`.
...
To configure Euromonitor provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the SSO URL is https://company.euromonitor.com/sp/ACS.saml2, then the sub domain is company.
...
#. Select the SAML SSO object created for for Euromonitor, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Euromonitor service.

Setup Euromonitor as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Euromonitor documentation to set it up as SAML Service Provider.
