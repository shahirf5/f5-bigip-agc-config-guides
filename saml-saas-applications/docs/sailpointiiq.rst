...
To configure Sailpoint IIQ provide following inputs:
	- **Sailpoint IIQ host** : Specify Sailpoint IIQ host which is used to setup entityId, example: if ACS URL is https://company/identityiq/login.jsf, then Sailpoint IIQ host is company
