...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Sailpoint IIQ:
...
Sailpoint IIQ Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Sailpoint IIQ, select Sailpoint IIQ and click :guilabel:`Add`.
...
To configure Sailpoint IIQ provide following inputs:
	- :guilabel:`Sailpoint IIQ host` : Specify Sailpoint IIQ host. Entity ID uses this value. If ACS URL is https://company/identityiq/login.jsf, then Sailpoint IIQ host is company
...
#. Select the SAML SSO object created for for Sailpoint IIQ, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Sailpoint IIQ service.

Setup Sailpoint IIQ as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Sailpoint IIQ documentation to set it up as SAML Service Provider.
