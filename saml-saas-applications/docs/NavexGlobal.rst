...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Navex Global:
...
Navex Global Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Navex Global, select Navex Global and click :guilabel:`Add`.
...
To configure Navex Global provide following inputs:
	- :guilabel:`Partition Name` : Provide your partition name registered with Navex.
...
Refer to Navex Global documentation to set it up as SAML Service Provider.
