...
For example, to configure Navex Global, select Navex Global and click ``Add``.
...
#. Select the SAML SSO object created for for Navex Global, and click ``Export Metadata``.
