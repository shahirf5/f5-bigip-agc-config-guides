...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Salesforce:
...
Salesforce Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Salesforce, select Salesforce and click :guilabel:`Add`.
...
To configure Salesforce provide following inputs:
	- :guilabel:`Domain Specific ID` : Provide your domain specific unique id.
	- :guilabel:`Sub Domain` : Provide the sub domain for your salesforce application. If the Entity ID is https://company.my.salesforce.com, then company is the sub domain
...
Refer to Salesforce documentation to set it up as SAML Service Provider.
