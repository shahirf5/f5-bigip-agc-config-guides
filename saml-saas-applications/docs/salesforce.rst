...
For example, to configure Salesforce, select Salesforce and click ``Add``.
...
To configure Salesforce provide following inputs:
	...
	- ``Sub Domain`` : Provide the sub domain for your salesforce application. If the Entity ID is https://company.my.salesforce.com, then company is the sub domain
...
#. Select the SAML SSO object created for for Salesforce, and click ``Export Metadata``.
