...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Harvard Business Publishing:
...
Harvard Business Publishing Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Harvard Business Publishing, select Harvard Business Publishing and click :guilabel:`Add`.
...
Refer to Harvard Business Publishing documentation to set it up as SAML Service Provider.
