...
For example, to configure Harvard Business Publishing, select Harvard Business Publishing and click ``Add``.
...
#. Select the SAML SSO object created for for Harvard Business Publishing, and click ``Export Metadata``.
