...
For example, to configure ServiceNow, select ServiceNow and click **Add**.
...
To configure ServiceNow provide following inputs:
	- **Sub Domain** : Provide your sub domain from the SSO URL. For eg - If the URL is https://company.service-now.com, then sub domain is company.
...
#. Select the SAML SSO object created for for ServiceNow, and click **Export Metadata**.
