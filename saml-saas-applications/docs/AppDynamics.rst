...
For example, to configure AppDynamics, select AppDynamics and click **Add**.
...
To configure AppDynamics provide following inputs:
	- **Sub Domain** : Provide the sub domain. For e.g. if the Entity ID URL is https://company.saas.appdynamics.com/controller, the sub domain is company
...
#. Select the SAML SSO object created for for AppDynamics, and click **Export Metadata**.
