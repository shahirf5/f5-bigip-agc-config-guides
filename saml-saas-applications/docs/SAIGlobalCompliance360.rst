...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Compliance360:
...
Compliance360 Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Compliance360, select Compliance360 and click :guilabel:`Add`.
...
To configure Compliance360 provide following inputs:
	- :guilabel:`Organization ID` : Provide your Organization ID used for login to Compliance360
...
Refer to Compliance360 documentation to set it up as SAML Service Provider.
