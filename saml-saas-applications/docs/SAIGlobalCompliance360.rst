...
For example, to configure Compliance360, select Compliance360 and click **Add**.
...
#. Select the SAML SSO object created for for Compliance360, and click **Export Metadata**.
