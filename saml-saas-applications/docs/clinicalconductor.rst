======================================================================================
SaaS Application Configuration Guide : Clinical Conductor
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Clinical Conductor:
...
Clinical Conductor Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Clinical Conductor, select Clinical Conductor and click :guilabel:`Add`.
...
To configure Clinical Conductor provide following inputs:
	- :guilabel:`Sub Domain` : Enter your sub domain. For example, if your ACS URL is https://yourcompany.clinicalconductor.com/CCSWeb/SSO/SAML2/frmSignIn.aspx, enter: yourcompany
...
#. Select the SAML SSO object created for for Clinical Conductor, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Clinical Conductor service.

Setup Clinical Conductor as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Clinical Conductor documentation to set it up as SAML Service Provider.
