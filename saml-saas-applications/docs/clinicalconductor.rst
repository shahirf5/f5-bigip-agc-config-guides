...
For example, to configure Clinical Conductor, select Clinical Conductor and click **Add**.
...
To configure Clinical Conductor provide following inputs:
	- **Sub Domain** : Enter your sub domain. For example, if your ACS URL is https://yourcompany.clinicalconductor.com/CCSWeb/SSO/SAML2/frmSignIn.aspx, enter: yourcompany
...
#. Select the SAML SSO object created for for Clinical Conductor, and click **Export Metadata**.
