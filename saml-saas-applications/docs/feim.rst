...
For example, to configure First Eagle Investment Management, select First Eagle Investment Management and click ``Add``.
...
To configure First Eagle Investment Management provide following inputs:
	- ``Sub Domain`` : Specify Sub Domain value. Entity Id uses this value. For example, if your entityId is https://acme.feim.com/acme_sp then your sub domain is acme.
...
#. Select the SAML SSO object created for for First Eagle Investment Management, and click ``Export Metadata``.
