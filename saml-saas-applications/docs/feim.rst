...
To configure First Eagle Investment Management provide following inputs:
	- **Sub Domain** : Specify Sub Domain which is used to setup if your entityId, for example, if your entityId is https://acme.feim.com/acme_sp then your sub domain is acme.
