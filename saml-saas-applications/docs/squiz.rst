...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Squiz:
...
Squiz Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Squiz, select Squiz and click :guilabel:`Add`.
...
To configure Squiz provide following inputs:
	- :guilabel:`Squiz Hostname` : Specify Squiz hostname or site. If your entity ID is https://acme/saml, then enter acme
...
#. Select the SAML SSO object created for for Squiz, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Squiz service.

Setup Squiz as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Squiz documentation to set it up as SAML Service Provider.
