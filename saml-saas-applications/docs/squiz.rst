...
For example, to configure Squiz, select Squiz and click ``Add``.
...
To configure Squiz provide following inputs:
	- ``Squiz Hostname`` : Specify Squiz hostname or site. If your entity ID is https://acme/saml, then enter acme
...
#. Select the SAML SSO object created for for Squiz, and click ``Export Metadata``.
