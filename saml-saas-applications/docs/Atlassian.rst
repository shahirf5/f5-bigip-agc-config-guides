=================================================================
SaaS Application Configuration Guide : Atlassian
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Atlassian:
...
Atlassian Configuration in AGC Workflow
----------------------------------------------
...
Atlassian, select
Atlassian and click on **Add** button
...
Atlassian does not require any user input.
...
#. Identify the Saml SSO object created for for Atlassian and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Atlassian service.
