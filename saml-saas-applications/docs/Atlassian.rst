...
Atlassian Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Atlassian, select Atlassian and click :guilabel:`Add`.
...
#. Select the SAML SSO object created for for Atlassian, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Atlassian service.

Setup Atlassian as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Atlassian documentation to set it up as SAML Service Provider.
