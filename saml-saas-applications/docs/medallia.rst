...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Medallia:
...
Medallia Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Medallia, select Medallia and click :guilabel:`Add`.
...
To configure Medallia provide following inputs:
	- :guilabel:`Customer ID` : Specify Customer ID. Entity Id and ACS URL use this value. If your ACS URL is https://domain.medallia.com/sso/customerId, then enter customerId
	- :guilabel:`Medallia Domain` : Specify medallia domain. Entity Id and ACS URL use this value. For example, if your ACS URL is https://domain.medallia.com/sso/customerId, then enter domain
...
#. Select the SAML SSO object created for for Medallia, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Medallia service.

Setup Medallia as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Medallia documentation to set it up as SAML Service Provider.
