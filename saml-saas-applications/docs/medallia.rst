...
For example, to configure Medallia, select Medallia and click **Add**.
...
To configure Medallia provide following inputs:
	- **Customer ID** : Specify Customer ID. Entity Id and ACS URL use this value. If your ACS URL is https://domain.medallia.com/sso/customerId, then enter customerId
	- **Medallia Domain** : Specify medallia domain. Entity Id and ACS URL use this value. For example, if your ACS URL is https://domain.medallia.com/sso/customerId, then enter domain
...
#. Select the SAML SSO object created for for Medallia, and click **Export Metadata**.
