...
To configure Medallia provide following inputs:
	- **Customer ID** : Specify Customer ID which is used along with domain to setup entity ID, example https://<domain>.medallia.com/sso/<customerId>
	- **Medallia Domain** : Specify medallia domain which is used along with customer ID to setup entity ID, example https://<domain>.medallia.com/sso/<customerId>
