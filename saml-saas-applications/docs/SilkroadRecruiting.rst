...
For example, to configure Silkroad Recruiting, select Silkroad Recruiting and click :guilabel:`Add`.
...
To configure Silkroad Recruiting provide following inputs:
	- :guilabel:`Domain Name` : From the SSO URL https://company.auth.silkroad.com/adfs/ls/ , domain is company.auth.silkroad.com
...
#. Select the SAML SSO object created for for Silkroad Recruiting, and click :guilabel:`Export Metadata`.
...
Refer to Silkroad Recruiting documentation to set it up SAML Service Provider.
