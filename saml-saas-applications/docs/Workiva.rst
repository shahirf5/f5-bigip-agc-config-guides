======================================================================================
SaaS Application Configuration Guide : Workiva
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Workiva:
...
Workiva Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Workiva, select Workiva and click :guilabel:`Add`.
...
To configure Workiva provide following inputs:
	- :guilabel:`Unique ID` : Provide the workiva unique id from the SSO URL. For eg - If SSO URL is https://webfilings.appspot.com/auth/saml/sp/metadata/abcd1234, then abcd1234 is the workiva id.
...
#. Select the SAML SSO object created for for Workiva, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Workiva service.

Setup Workiva as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Workiva documentation to set it up as SAML Service Provider.
