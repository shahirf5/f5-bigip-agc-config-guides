...
For example, to configure Dayforce HCM, select Dayforce HCM and click ``Add``.
...
#. Select the SAML SSO object created for for Dayforce HCM, and click ``Export Metadata``.
