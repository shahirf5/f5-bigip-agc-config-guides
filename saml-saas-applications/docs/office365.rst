...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Microsoft Office 365:
...
Microsoft Office 365 Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Microsoft Office 365, select Microsoft Office 365 and click :guilabel:`Add`.
...
Refer to Microsoft Office 365 documentation to set it up as SAML Service Provider.
