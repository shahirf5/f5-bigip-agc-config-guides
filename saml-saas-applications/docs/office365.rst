...
For example, to configure Microsoft Office 365, select Microsoft Office 365 and click ``Add``.
...
#. Select the SAML SSO object created for for Microsoft Office 365, and click ``Export Metadata``.
