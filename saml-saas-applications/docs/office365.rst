=================================================================
SaaS Application Configuration Guide : Microsoft Office 365
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Microsoft Office 365:
...
Microsoft Office 365 Configuration in AGC Workflow
----------------------------------------------
...
Microsoft Office 365, select
Microsoft Office 365 and click on **Add** button
...
Microsoft Office 365 does not require any user input.
...
#. Identify the Saml SSO object created for for Microsoft Office 365 and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Microsoft Office 365 service.
