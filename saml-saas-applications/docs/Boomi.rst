...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure boomi.com:
...
boomi.com Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure boomi.com, select boomi.com and click :guilabel:`Add`.
...
To configure boomi.com provide following inputs:
	- :guilabel:`Company ID` : Provide the company ID. If your SSO URL is https://platform.boomi.com/sso/testCompany/saml, testCompany is the company ID
...
Refer to boomi.com documentation to set it up as SAML Service Provider.
