...
For example, to configure GeoLearning, select GeoLearning and click ``Add``.
...
To configure GeoLearning provide following inputs:
	- ``Customer ID`` : Specify Customer Id. For example in entityId https://gm1.geolearning.com/geonext/customerId/saml.geo, customerId is the Cutomer ID.
...
#. Select the SAML SSO object created for for GeoLearning, and click ``Export Metadata``.
