...
For example, to configure Oracle Hyperion, select Oracle Hyperion and click **Add**.
...
#. Select the SAML SSO object created for for Oracle Hyperion, and click **Export Metadata**.
