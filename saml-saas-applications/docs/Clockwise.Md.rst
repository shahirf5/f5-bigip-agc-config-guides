======================================================================================
SaaS Application Configuration Guide : Clockwise.Md
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Clockwise.Md:
...
For example, to configure Clockwise.Md, select Clockwise.Md and click :guilabel:`Add`.
...
To configure Clockwise.Md provide following inputs:
	- :guilabel:`Login Domain Name` : Provide the login domain name
...
#. Select the SAML SSO object created for for Clockwise.Md, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Clockwise.Md service.

Setup Clockwise.Md as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Clockwise.Md documentation to set it up SAML Service Provider.
