...
For example, to configure SmartRecruiters, select SmartRecruiters and click ``Add``.
...
To configure SmartRecruiters provide following inputs:
	- ``Company ID`` : Provide the companyIdentifier from the ACS URL. For example, if your ACS URL is https://www.smartrecruiters.com/web-sso/saml/CompanyIdentifier/login, then enter CompanyIdentifier
...
#. Select the SAML SSO object created for for SmartRecruiters, and click ``Export Metadata``.
