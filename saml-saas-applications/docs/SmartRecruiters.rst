======================================================================================
SaaS Application Configuration Guide : SmartRecruiters
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure SmartRecruiters:
...
SmartRecruiters Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure SmartRecruiters, select SmartRecruiters and click :guilabel:`Add`.
...
To configure SmartRecruiters provide following inputs:
	- :guilabel:`Company ID` : Provide the companyIdentifier from the ACS URL. For example, if your ACS URL is https://www.smartrecruiters.com/web-sso/saml/CompanyIdentifier/login, then enter CompanyIdentifier
...
#. Select the SAML SSO object created for for SmartRecruiters, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the SmartRecruiters service.

Setup SmartRecruiters as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to SmartRecruiters documentation to set it up as SAML Service Provider.
