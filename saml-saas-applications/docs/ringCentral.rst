...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure RingCentral:
...
RingCentral Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure RingCentral, select RingCentral and click :guilabel:`Add`.
...
To configure RingCentral provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the SSO URL is https://company.ringcentral.com/sp/ACS.saml2, then the sub domain is company.
	- :guilabel:`Entity ID` : Please provide the Entity ID
...
Refer to RingCentral documentation to set it up as SAML Service Provider.
