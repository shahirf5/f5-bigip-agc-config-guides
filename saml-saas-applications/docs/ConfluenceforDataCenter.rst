...
For example, to configure Atlassian Confluence Enterprise, select Atlassian Confluence Enterprise and click **Add**.
...
#. Select the SAML SSO object created for for Atlassian Confluence Enterprise, and click **Export Metadata**.
