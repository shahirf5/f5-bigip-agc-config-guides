...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Atlassian Confluence Enterprise:
...
Atlassian Confluence Enterprise Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Atlassian Confluence Enterprise, select Atlassian Confluence Enterprise and click :guilabel:`Add`.
...
Refer to Atlassian Confluence Enterprise documentation to set it up as SAML Service Provider.
