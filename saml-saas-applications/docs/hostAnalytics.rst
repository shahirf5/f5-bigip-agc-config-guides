=================================================================
SaaS Application Configuration Guide : HostAnalytics
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure HostAnalytics:
...
HostAnalytics Configuration in AGC Workflow
----------------------------------------------
...
HostAnalytics, select
HostAnalytics and click on **Add** button
...
To configure HostAnalytics provide following inputs:
	- **Entity ID** : Please provide Entity ID
...
#. Identify the Saml SSO object created for for HostAnalytics and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in HostAnalytics service.
