...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure HostAnalytics:
...
HostAnalytics Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure HostAnalytics, select HostAnalytics and click :guilabel:`Add`.
...
To configure HostAnalytics provide following inputs:
	- :guilabel:`Entity ID` : Please provide Entity ID
...
Refer to HostAnalytics documentation to set it up as SAML Service Provider.
