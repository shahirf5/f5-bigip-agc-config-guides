...
For example, to configure HostAnalytics, select HostAnalytics and click ``Add``.
...
#. Select the SAML SSO object created for for HostAnalytics, and click ``Export Metadata``.
