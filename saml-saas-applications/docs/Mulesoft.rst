...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Mulesoft:
...
Mulesoft Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Mulesoft, select Mulesoft and click :guilabel:`Add`.
...
To configure Mulesoft provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain of your organization. For example, if your entity ID is domain.anypoint.mulesoft.com, then enter domain
...
#. Select the SAML SSO object created for for Mulesoft, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Mulesoft service.

Setup Mulesoft as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Mulesoft documentation to set it up as SAML Service Provider.
