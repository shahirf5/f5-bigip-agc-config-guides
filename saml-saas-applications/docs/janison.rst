...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Janison Learning:
...
Janison Learning Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Janison Learning, select Janison Learning and click :guilabel:`Add`.
...
To configure Janison Learning provide following inputs:
	- :guilabel:`Sub Domain` : Specify sub domain, for example if your entity ID is https://acme.cls.janison.com then your sub domain is acme
...
#. Select the SAML SSO object created for for Janison Learning, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Janison Learning service.

Setup Janison Learning as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Janison Learning documentation to set it up as SAML Service Provider.
