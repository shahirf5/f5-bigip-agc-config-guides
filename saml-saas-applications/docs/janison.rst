...
For example, to configure Janison Learning, select Janison Learning and click **Add**.
...
To configure Janison Learning provide following inputs:
	- **Sub Domain** : Specify sub domain, for example if your entity ID is https://acme.cls.janison.com then your sub domain is acme
...
#. Select the SAML SSO object created for for Janison Learning, and click **Export Metadata**.
