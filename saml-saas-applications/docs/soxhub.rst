...
For example, to configure SOXHUB, select SOXHUB and click **Add**.
...
To configure SOXHUB provide following inputs:
	- **Sub Domain** : Provide the sub domain from the SSO URL. For eg - If the SSO URL is https://testcompany.soxhub.com/api/v1/sso/saml/assert, then the sub domain is testcompany.
...
#. Select the SAML SSO object created for for SOXHUB, and click **Export Metadata**.
