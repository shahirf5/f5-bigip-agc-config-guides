======================================================================================
SaaS Application Configuration Guide : SOXHUB
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure SOXHUB:
...
SOXHUB Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure SOXHUB, select SOXHUB and click :guilabel:`Add`.
...
To configure SOXHUB provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain from the SSO URL. For eg - If the SSO URL is https://testcompany.soxhub.com/api/v1/sso/saml/assert, then the sub domain is testcompany.
...
#. Select the SAML SSO object created for for SOXHUB, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the SOXHUB service.

Setup SOXHUB as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to SOXHUB documentation to set it up as SAML Service Provider.
