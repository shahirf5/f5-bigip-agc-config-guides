...
For example, to configure Microstrategy, select Microstrategy and click **Add**.
...
#. Select the SAML SSO object created for for Microstrategy, and click **Export Metadata**.
