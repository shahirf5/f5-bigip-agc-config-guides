=================================================================
SaaS Application Configuration Guide : educause.edu
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure educause.edu:
...
educause.edu Configuration in AGC Workflow
----------------------------------------------
...
educause.edu, select
educause.edu and click on **Add** button
...
educause.edu does not require any user input.
...
#. Identify the Saml SSO object created for for educause.edu and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in educause.edu service.
