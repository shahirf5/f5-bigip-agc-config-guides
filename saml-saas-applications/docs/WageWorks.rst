...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure WageWorks:
...
WageWorks Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure WageWorks, select WageWorks and click :guilabel:`Add`.
...
To configure WageWorks provide following inputs:
	- :guilabel:`Sub Domain` : Enter your sub domain. For example, if you log into https://acme.wageworks.com/sp/ACS.saml2, enter: acme
	- :guilabel:`ProgramSponsorID` : Please, enter your ProgramSponsorID
...
#. Select the SAML SSO object created for for WageWorks, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the WageWorks service.

Setup WageWorks as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to WageWorks documentation to set it up as SAML Service Provider.
