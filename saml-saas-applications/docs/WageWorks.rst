...
For example, to configure WageWorks, select WageWorks and click ``Add``.
...
To configure WageWorks provide following inputs:
	- ``Sub Domain`` : Enter your sub domain. For example, if you log into https://acme.wageworks.com/sp/ACS.saml2, enter: acme
...
#. Select the SAML SSO object created for for WageWorks, and click ``Export Metadata``.
