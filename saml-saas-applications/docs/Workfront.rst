...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Workfront:
...
Workfront Configuration in AGC Workflow
----------------------------------------------
...
Workfront, select
Workfront and click on **Add** button
...
#. Identify the Saml SSO object created for for Workfront and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Workfront service.
