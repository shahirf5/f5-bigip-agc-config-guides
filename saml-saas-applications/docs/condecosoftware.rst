...
For example, to configure Condeco Software, select Condeco Software and click **Add**.
...
#. Select the SAML SSO object created for for Condeco Software, and click **Export Metadata**.
