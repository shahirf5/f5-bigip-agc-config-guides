======================================================================================
SaaS Application Configuration Guide : Hype Innovation
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Hype Innovation:
...
Hype Innovation Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Hype Innovation, select Hype Innovation and click :guilabel:`Add`.
...
To configure Hype Innovation provide following inputs:
	- :guilabel:`Sub Domain` : Enter your sub domain. For example, if your ACS URL is https://yourcompany.hypeinnovation.com/Shibboleth.sso/autologin, enter: yourcompany
...
#. Select the SAML SSO object created for for Hype Innovation, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Hype Innovation service.

Setup Hype Innovation as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Hype Innovation documentation to set it up as SAML Service Provider.
