...
For example, to configure Hype Innovation, select Hype Innovation and click **Add**.
...
To configure Hype Innovation provide following inputs:
	- **Sub Domain** : Enter your sub domain. For example, if your ACS URL is https://yourcompany.hypeinnovation.com/Shibboleth.sso/autologin, enter: yourcompany
...
#. Select the SAML SSO object created for for Hype Innovation, and click **Export Metadata**.
