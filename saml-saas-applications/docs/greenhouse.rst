...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Greenhouse:
...
Greenhouse Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Greenhouse, select Greenhouse and click :guilabel:`Add`.
...
To configure Greenhouse provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg if the ACS URL is https://company.greenhouse.io/users/saml/consume, the sub domain is company.
...
Refer to Greenhouse documentation to set it up as SAML Service Provider.
