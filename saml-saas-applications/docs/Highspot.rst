=================================================================
SaaS Application Configuration Guide : Highspot
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Highspot:
...
Highspot Configuration in AGC Workflow
----------------------------------------------
...
Highspot, select
Highspot and click on **Add** button
...
Highspot does not require any user input.
...
#. Identify the Saml SSO object created for for Highspot and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Highspot service.
