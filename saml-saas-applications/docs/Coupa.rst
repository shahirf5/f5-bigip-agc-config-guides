=================================================================
SaaS Application Configuration Guide : Coupa
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Coupa:
...
Coupa Configuration in AGC Workflow
----------------------------------------------
...
To configure Coupa provide following inputs:
	- **Instance Domain name** : Provide the coupahost instance domain name.
	- **Production or Staging** : Select appropriate deployment environment.
...
#. Identify the Saml SSO object created for for Coupa and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Coupa service.
