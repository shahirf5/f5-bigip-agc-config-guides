...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Coupa:
...
Coupa Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Coupa, select Coupa and click :guilabel:`Add`.
...
To configure Coupa provide following inputs:
	- :guilabel:`Instance Domain name` : Provide the coupahost instance domain name.
	- :guilabel:`Production or Staging` : Select appropriate deployment environment.
...
Refer to Coupa documentation to set it up as SAML Service Provider.
