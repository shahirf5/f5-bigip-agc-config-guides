...
For example, to configure Arcgis, select Arcgis and click **Add**.
...
To configure Arcgis provide following inputs:
	- **Sub Domain** : If your SSO URL is https://company.maps.arcgis.com/sharing/rest/oauth2/saml/signin, then sub domain is company.
...
#. Select the SAML SSO object created for for Arcgis, and click **Export Metadata**.
