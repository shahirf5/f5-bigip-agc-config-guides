======================================================================================
SaaS Application Configuration Guide : ATI Cloud
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure ATI Cloud:
...
ATI Cloud Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure ATI Cloud, select ATI Cloud and click :guilabel:`Add`.
...
To configure ATI Cloud provide following inputs:
	- :guilabel:`ATI Datacenter Site` : Specify ATI Datacenter Site. Entity Id uses this value. For example, if your Entity Id is https://datacenter_location/sp, enter datacenter_location
...
#. Select the SAML SSO object created for for ATI Cloud, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the ATI Cloud service.

Setup ATI Cloud as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to ATI Cloud documentation to set it up as SAML Service Provider.
