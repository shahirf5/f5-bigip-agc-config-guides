======================================================================================
SaaS Application Configuration Guide : Appian
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Appian:
...
Appian Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Appian, select Appian and click :guilabel:`Add`.
...
To configure Appian provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the SSO URL is https://company.appiancloud.com/suite/saml/AssertionConsumer, then the sub domain is company.
...
#. Select the SAML SSO object created for for Appian, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Appian service.

Setup Appian as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Appian documentation to set it up as SAML Service Provider.
