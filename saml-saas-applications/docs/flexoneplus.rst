=================================================================
SaaS Application Configuration Guide : Flex-OnePlus
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Flex-OnePlus:
...
Flex-OnePlus Configuration in AGC Workflow
----------------------------------------------
...
Flex-OnePlus, select
Flex-OnePlus and click on **Add** button
...
Flex-OnePlus does not require any user input.
...
#. Identify the Saml SSO object created for for Flex-OnePlus and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Flex-OnePlus service.
