...
For example, to configure Silkroad Redcarpet, select Silkroad Redcarpet and click ``Add``.
...
#. Select the SAML SSO object created for for Silkroad Redcarpet, and click ``Export Metadata``.
