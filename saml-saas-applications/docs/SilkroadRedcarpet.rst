...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Silkroad Redcarpet:
...
Silkroad Redcarpet Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Silkroad Redcarpet, select Silkroad Redcarpet and click :guilabel:`Add`.
...
To configure Silkroad Redcarpet provide following inputs:
	- :guilabel:`Sub Domain` : If the SSO URL is https://company.silkroad.com/Authentication/, sub domain is company
...
#. Select the SAML SSO object created for for Silkroad Redcarpet, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Silkroad Redcarpet service.
