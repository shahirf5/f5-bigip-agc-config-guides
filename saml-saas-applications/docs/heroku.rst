...
For example, to configure Heroku, select Heroku and click **Add**.
...
To configure Heroku provide following inputs:
	- **Company Name** : Enter your company name id. For example if your ACS URL is https://sso.heroku.com/saml/yourcompany/finalize, enter: yourcompany
...
#. Select the SAML SSO object created for for Heroku, and click **Export Metadata**.
