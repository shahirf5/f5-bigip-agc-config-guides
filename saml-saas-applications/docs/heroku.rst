======================================================================================
SaaS Application Configuration Guide : Heroku
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Heroku:
...
Heroku Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Heroku, select Heroku and click :guilabel:`Add`.
...
To configure Heroku provide following inputs:
	- :guilabel:`Company Name` : Enter your company name id. For example if your ACS URL is https://sso.heroku.com/saml/yourcompany/finalize, enter: yourcompany
...
#. Select the SAML SSO object created for for Heroku, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Heroku service.

Setup Heroku as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Heroku documentation to set it up as SAML Service Provider.
