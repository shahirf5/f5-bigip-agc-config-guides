...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure BrightIdea:
...
BrightIdea Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure BrightIdea, select BrightIdea and click :guilabel:`Add`.
...
To configure BrightIdea provide following inputs:
	- :guilabel:`domainName` : Domain Name
...
#. Select the SAML SSO object created for for BrightIdea, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the BrightIdea service.

Setup BrightIdea as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to BrightIdea documentation to set it up as SAML Service Provider.
