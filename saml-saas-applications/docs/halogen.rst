======================================================================================
SaaS Application Configuration Guide : Halogen Software
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Halogen Software:
...
Halogen Software Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Halogen Software, select Halogen Software and click :guilabel:`Add`.
...
To configure Halogen Software provide following inputs:
	- :guilabel:`Halogen Site` : Specify Halogen Site value. Entity Id uses this value. For example, if entity Id is https://company/saml/metadata, enter company
...
#. Select the SAML SSO object created for for Halogen Software, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Halogen Software service.

Setup Halogen Software as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Halogen Software documentation to set it up as SAML Service Provider.
