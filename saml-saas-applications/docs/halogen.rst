...
For example, to configure Halogen Software, select Halogen Software and click **Add**.
...
To configure Halogen Software provide following inputs:
	- **Halogen Site** : Specify Halogen Site value. Entity Id uses this value. For example, if entity Id is https://company/saml/metadata, enter company
...
#. Select the SAML SSO object created for for Halogen Software, and click **Export Metadata**.
