...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Halogen Software:
...
Halogen Software Configuration in AGC Workflow
---------------------------------------------------------------------------
...
Halogen Software, select
Halogen Software and click on **Add** button
...
#. Identify the Saml SSO object created for for Halogen Software and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Halogen Software service.
