...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Smart Sheet:
...
Smart Sheet Configuration in AGC Workflow
----------------------------------------------
...
Smart Sheet, select
Smart Sheet and click on **Add** button
...
#. Identify the Saml SSO object created for for Smart Sheet and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Smart Sheet service.
