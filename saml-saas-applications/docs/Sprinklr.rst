...
For example, to configure Sprinklr, select Sprinklr and click **Add**.
...
To configure Sprinklr provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg - In SSO URL, https://company.sprinklr.com/ui/sso/saml/249, company is the sub domain
...
#. Select the SAML SSO object created for for Sprinklr, and click **Export Metadata**.
