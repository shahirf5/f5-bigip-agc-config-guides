...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Netsuite:
...
Netsuite Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Netsuite, select Netsuite and click :guilabel:`Add`.
...
To configure Netsuite provide following inputs:
	- :guilabel:`Netsuite Account ID` : Provide your netsuite account ID obtained from Netsuite administrator.
	- :guilabel:`Sub Domain` : Provide the sub domain from the SSO URL. For eg - If URL is https://system.testcompany.netsuite.com/saml2/acs, then sub domain is testcompany.
...
#. Select the SAML SSO object created for for Netsuite, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Netsuite service.

Setup Netsuite as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Netsuite documentation to set it up as SAML Service Provider.
