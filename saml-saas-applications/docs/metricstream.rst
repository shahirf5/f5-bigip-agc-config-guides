...
For example, to configure MetricStream, select MetricStream and click ``Add``.
...
To configure MetricStream provide following inputs:
	- ``Sub Domain`` : Enter your sub domain. For example, if your ACS URL is https://yourcompany.metricstream.com/metricstream/saml/SAMLAssertionConsumer, enter: yourcompany
...
#. Select the SAML SSO object created for for MetricStream, and click ``Export Metadata``.
