======================================================================================
SaaS Application Configuration Guide : MetricStream
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure MetricStream:
...
MetricStream Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure MetricStream, select MetricStream and click :guilabel:`Add`.
...
To configure MetricStream provide following inputs:
	- :guilabel:`Sub Domain` : Enter your sub domain. For example, if your ACS URL is https://yourcompany.metricstream.com/metricstream/saml/SAMLAssertionConsumer, enter: yourcompany
...
#. Select the SAML SSO object created for for MetricStream, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the MetricStream service.

Setup MetricStream as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to MetricStream documentation to set it up as SAML Service Provider.
