...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Verint:
...
Verint Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Verint, select Verint and click :guilabel:`Add`.
...
To configure Verint provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg if the SSO URL is https://company.verint.com, the sub domain is company.
...
Refer to Verint documentation to set it up as SAML Service Provider.
