...
For example, to configure Verint, select Verint and click **Add**.
...
To configure Verint provide following inputs:
	- **Sub Domain** : Provide the sub domain. For eg if the SSO URL is https://company.verint.com, the sub domain is company.
...
#. Select the SAML SSO object created for for Verint, and click **Export Metadata**.
