======================================================================================
SaaS Application Configuration Guide : Novatus
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Novatus:
...
Novatus Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Novatus, select Novatus and click :guilabel:`Add`.
...
To configure Novatus provide following inputs:
	- :guilabel:`Company ID` : Provide the company ID from the SSO URL. For eg - If SSO URL is https://sso.novatuscontracts.com/test1234.samlpost, then company ID is test1234.
...
#. Select the SAML SSO object created for for Novatus, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Novatus service.

Setup Novatus as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Novatus documentation to set it up as SAML Service Provider.
