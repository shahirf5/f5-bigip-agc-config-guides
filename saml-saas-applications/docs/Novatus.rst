...
For example, to configure Novatus, select Novatus and click **Add**.
...
To configure Novatus provide following inputs:
	- **Company ID** : Provide the company ID from the SSO URL. For eg - If SSO URL is https://sso.novatuscontracts.com/test1234.samlpost, then company ID is test1234.
...
#. Select the SAML SSO object created for for Novatus, and click **Export Metadata**.
