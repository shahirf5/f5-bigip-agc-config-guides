=================================================================
SaaS Application Configuration Guide : Amazon Web Services
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Amazon Web Services:
...
Amazon Web Services Configuration in AGC Workflow
----------------------------------------------
...
Amazon Web Services, select
Amazon Web Services and click on **Add** button
...
To configure Amazon Web Services provide following inputs:
	...
	- **AWS IdP Name** : Provide the name of the identity provider. Make sure that the same name is configured in Identity Providers section in AWS.
...
#. Identify the Saml SSO object created for for Amazon Web Services and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Amazon Web Services service.
