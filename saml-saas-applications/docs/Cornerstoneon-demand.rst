...
For example, to configure Cornerstone on-demand, select Cornerstone on-demand and click **Add**.
...
#. Select the SAML SSO object created for for Cornerstone on-demand, and click **Export Metadata**.
