...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Cornerstone on-demand:
...
Cornerstone on-demand Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Cornerstone on-demand, select Cornerstone on-demand and click :guilabel:`Add`.
...
To configure Cornerstone on-demand provide following inputs:
	- :guilabel:`Sub Domain` : From the SSO URL like https://company.csod.com, sub Domain is company
