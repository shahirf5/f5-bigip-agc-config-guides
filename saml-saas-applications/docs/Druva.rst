...
For example, to configure Druva, select Druva and click ``Add``.
...
To configure Druva provide following inputs:
	- ``Customer Token`` : The value of this attribute comes from the SAML configuration page on the inSync Cloud Settings section.
...
#. Select the SAML SSO object created for for Druva, and click ``Export Metadata``.
