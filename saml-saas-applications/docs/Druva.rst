...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Druva:
...
Druva Configuration in AGC Workflow
----------------------------------------------
...
#. Identify the Saml SSO object created for for Druva and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Druva service.
