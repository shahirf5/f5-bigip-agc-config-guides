=================================================================
SaaS Application Configuration Guide : BlueJeans
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure BlueJeans:
...
BlueJeans Configuration in AGC Workflow
----------------------------------------------
...
BlueJeans, select
BlueJeans and click on **Add** button
...
BlueJeans does not require any user input.
...
#. Identify the Saml SSO object created for for BlueJeans and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in BlueJeans service.
