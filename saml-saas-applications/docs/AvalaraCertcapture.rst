======================================================================================
SaaS Application Configuration Guide : Avalara
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Avalara:
...
Avalara Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Avalara, select Avalara and click :guilabel:`Add`.
...
To configure Avalara provide following inputs:
	- :guilabel:`Company Id` : Provide your company id. If the SSO URL is https://app.certcapture.com/logins/sso/company, then company is the company Id.
...
#. Select the SAML SSO object created for for Avalara, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Avalara service.

Setup Avalara as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Avalara documentation to set it up as SAML Service Provider.
