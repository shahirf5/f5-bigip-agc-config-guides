...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure BrightSpace by Desire2Learn:
...
BrightSpace by Desire2Learn Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure BrightSpace by Desire2Learn, select BrightSpace by Desire2Learn and click ``Add``.
...
#. Select the SAML SSO object created for for BrightSpace by Desire2Learn, and click ``Export Metadata``.
