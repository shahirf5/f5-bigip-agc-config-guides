...
For example, to configure BrightSpace by Desire2Learn, select BrightSpace by Desire2Learn and click :guilabel:`Add`.
...
To configure BrightSpace by Desire2Learn provide following inputs:
	- :guilabel:`Sub Domain` : Provide your sub domain. For eg - If your SSO URI is https://company.brightspace.com/shibboleth-sp, then the sub domain is company
