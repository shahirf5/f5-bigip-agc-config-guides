=================================================================
SaaS Application Configuration Guide : BrightSpace by Desire2Learn
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure BrightSpace by Desire2Learn:
...
BrightSpace by Desire2Learn Configuration in AGC Workflow
----------------------------------------------
...
BrightSpace by Desire2Learn, select
BrightSpace by Desire2Learn and click on **Add** button
...
To configure BrightSpace by Desire2Learn provide following inputs:
	- **Sub Domain** : Provide your sub domain. For eg - If your SSO URI is https://company.brightspace.com/shibboleth-sp, then the sub domain is company
...
#. Identify the Saml SSO object created for for BrightSpace by Desire2Learn and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in BrightSpace by Desire2Learn service.
