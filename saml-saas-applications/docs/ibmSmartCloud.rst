=================================================================
SaaS Application Configuration Guide : IBM SmartCloud for Social Business
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure IBM SmartCloud for Social Business:
...
IBM SmartCloud for Social Business Configuration in AGC Workflow
----------------------------------------------
...
IBM SmartCloud for Social Business, select
IBM SmartCloud for Social Business and click on **Add** button
...
To configure IBM SmartCloud for Social Business provide following inputs:
	- **Distribution Center** : Please choose, the Distribution Center Environment of your IBM Smart Cloud account
...
#. Identify the Saml SSO object created for for IBM SmartCloud for Social Business and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in IBM SmartCloud for Social Business service.
