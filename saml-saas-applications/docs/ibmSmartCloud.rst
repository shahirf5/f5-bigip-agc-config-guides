...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure IBM SmartCloud for Social Business:
...
IBM SmartCloud for Social Business Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure IBM SmartCloud for Social Business, select IBM SmartCloud for Social Business and click ``Add``.
...
#. Select the SAML SSO object created for for IBM SmartCloud for Social Business, and click ``Export Metadata``.
