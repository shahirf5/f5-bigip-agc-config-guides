...
For example, to configure IBM SmartCloud for Social Business, select IBM SmartCloud for Social Business and click :guilabel:`Add`.
...
To configure IBM SmartCloud for Social Business provide following inputs:
	- :guilabel:`Distribution Center` : Please choose, the Distribution Center Environment of your IBM Smart Cloud account
