======================================================================================
SaaS Application Configuration Guide : Google Suite
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Google Suite:
...
Google Suite Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Google Suite, select Google Suite and click :guilabel:`Add`.
...
To configure Google Suite provide following inputs:
	- :guilabel:`Service Providers Service Parameter` : Provide the parameter for the service to enable like mail, calendar, drive etc. For example, mail.google.com
	- :guilabel:`Use domain specific issuer` : Select Yes if you have a domain specific issuer.
	- :guilabel:`Domain Name` : Provide your domain name configured in G-suite.
