...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Google Suite:
...
Google Suite Configuration in AGC Workflow
---------------------------------------------------------------------------
...
Google Suite, select
Google Suite and click on **Add** button
...
To configure Google Suite provide following inputs:
	- **Service Providers Service Parameter** : Provide the parameter for the service to enable like mail, calendar, drive etc. For example, mail.google.com
...
#. Identify the Saml SSO object created for for Google Suite and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Google Suite service.
