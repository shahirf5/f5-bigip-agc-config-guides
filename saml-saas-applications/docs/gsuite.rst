...
For example, to configure Google Suite, select Google Suite and click **Add**.
...
#. Select the SAML SSO object created for for Google Suite, and click **Export Metadata**.
