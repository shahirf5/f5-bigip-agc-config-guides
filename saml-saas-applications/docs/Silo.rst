...
For example, to configure Silo Authentic8, select Silo Authentic8 and click :guilabel:`Add`.
...
To configure Silo Authentic8 provide following inputs:
	- :guilabel:`Company ID` : Provide your unique company ID from the SSO URL. For eg, from https://getsilo.com/sso/saml/company/login URL, company is the company ID.
