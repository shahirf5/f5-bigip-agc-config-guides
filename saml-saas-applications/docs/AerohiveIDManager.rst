...
For example, to configure Aerohive IDManager, select Aerohive IDManager and click ``Add``.
...
#. Select the SAML SSO object created for for Aerohive IDManager, and click ``Export Metadata``.
