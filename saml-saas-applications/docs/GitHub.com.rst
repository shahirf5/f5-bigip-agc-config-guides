=================================================================
SaaS Application Configuration Guide : GitHub.com
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure GitHub.com:
...
GitHub.com Configuration in AGC Workflow
----------------------------------------------
...
GitHub.com, select
GitHub.com and click on **Add** button
...
To configure GitHub.com provide following inputs:
	- **Organization** : Provide your GitHub organization name. For eg - In https://github.com/orgs/testorg, organization name is testorg.
...
#. Identify the Saml SSO object created for for GitHub.com and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in GitHub.com service.
