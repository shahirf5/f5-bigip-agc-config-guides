...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure GitHub.com:
...
GitHub.com Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure GitHub.com, select GitHub.com and click :guilabel:`Add`.
...
To configure GitHub.com provide following inputs:
	- :guilabel:`Organization` : Provide your GitHub organization name. For eg - In https://github.com/orgs/testorg, organization name is testorg.
...
Refer to GitHub.com documentation to set it up as SAML Service Provider.
