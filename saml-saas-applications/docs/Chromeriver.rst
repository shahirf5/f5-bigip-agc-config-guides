======================================================================================
SaaS Application Configuration Guide : Chromeriver
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Chromeriver:
...
Chromeriver Configuration in AGC Workflow
---------------------------------------------------------------------------
...
Chromeriver, select
Chromeriver and click on **Add** button
...
To configure Chromeriver provide following inputs:
	- **Server Type** : Select if Production or QA server
	- **Customer ID** : Specify Customer ID value. SSO URI uses this value. For example - If SSO URI is https://qa-app.chromeriver.com/login/sso/saml/consume\?customerId=xyz, customer ID is xyz
...
#. Identify the Saml SSO object created for for Chromeriver and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in Chromeriver service.
