...
For example, to configure TraceSecurity, select TraceSecurity and click ``Add``.
...
To configure TraceSecurity provide following inputs:
	- ``Sub Domain`` : Enter the sub domain
...
#. Select the SAML SSO object created for for TraceSecurity, and click ``Export Metadata``.
