...
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure TraceSecurity:
...
TraceSecurity Configuration in AGC Workflow
----------------------------------------------
...
TraceSecurity, select
TraceSecurity and click on **Add** button
...
#. Identify the Saml SSO object created for for TraceSecurity and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in TraceSecurity service.
