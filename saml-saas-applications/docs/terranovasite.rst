======================================================================================
SaaS Application Configuration Guide : Terranova
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Terranova:
...
Terranova Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Terranova, select Terranova and click :guilabel:`Add`.
...
To configure Terranova provide following inputs:
	- :guilabel:`Service UUID` : Specify Service UUID. If your ACS URL is https://secure.terranovasite.com/lms/login/saml2/tnssosp_ACS.aspx?e=1bac98a2-d7b0-46ea-a718-264ac8e77173 then enter 1bac98a2-d7b0-46ea-a718-264ac8e77173 for Service UUDI.
...
#. Select the SAML SSO object created for for Terranova, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Terranova service.

Setup Terranova as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Terranova documentation to set it up as SAML Service Provider.
