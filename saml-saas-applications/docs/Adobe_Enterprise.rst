...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Adobe Enterprise:
...
Adobe Enterprise Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Adobe Enterprise, select Adobe Enterprise and click :guilabel:`Add`.
...
To configure Adobe Enterprise provide following inputs:
	- :guilabel:`Entity ID` : Provide Adobe's EntityID URL from the metadata file or Adobe Administrator.
...
#. Select the SAML SSO object created for for Adobe Enterprise, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Adobe Enterprise service.

Setup Adobe Enterprise as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Adobe Enterprise documentation to set it up as SAML Service Provider.
