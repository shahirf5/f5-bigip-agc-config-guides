...
For example, to configure Adobe Enterprise, select Adobe Enterprise and click **Add**.
...
To configure Adobe Enterprise provide following inputs:
	- **Entity ID** : Provide Adobe's EntityID URL from the metadata file or Adobe Administrator.
...
#. Select the SAML SSO object created for for Adobe Enterprise, and click **Export Metadata**.
