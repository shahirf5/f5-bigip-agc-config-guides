=================================================================
SaaS Application Configuration Guide : knowledgeOwl
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure knowledgeOwl:
...
knowledgeOwl Configuration in AGC Workflow
----------------------------------------------
...
knowledgeOwl, select
knowledgeOwl and click on **Add** button
...
#. Identify the Saml SSO object created for for knowledgeOwl and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in knowledgeOwl service.
