...
For example, to configure knowledgeOwl, select knowledgeOwl and click :guilabel:`Add`.
...
To configure knowledgeOwl provide following inputs:
	- :guilabel:`Knowledge Base ID` : Enter your knowledge base id. For example if your ACS URL is https://app.knowledgeowl.com/kb/map-saml/id/1234, enter: 1234
...
#. Select the SAML SSO object created for for knowledgeOwl, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the knowledgeOwl service.

Setup knowledgeOwl as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to knowledgeOwl documentation to set it up as SAML Service Provider.
