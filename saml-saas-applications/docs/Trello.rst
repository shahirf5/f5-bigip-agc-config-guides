...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Trello:
...
Trello Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Trello, select Trello and click :guilabel:`Add`.
...
To configure Trello provide following inputs:
	- :guilabel:`Enterprise ID` : Provide the enterprise/company ID provided by Trello
...
#. Select the SAML SSO object created for for Trello, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Trello service.

Setup Trello as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Trello documentation to set it up as SAML Service Provider.
