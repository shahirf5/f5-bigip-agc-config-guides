======================================================================================
SaaS Application Configuration Guide : Inkling
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Inkling:
...
Inkling Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Inkling, select Inkling and click :guilabel:`Add`.
...
To configure Inkling provide following inputs:
	- :guilabel:`Account ID` : Provide the account Id from the SSO URL. For eg - If the SSO URL is https://api.inkling.com/saml/v2/metadata/abcdefgh12345566, then the account id is abcdefgh12345566
...
#. Select the SAML SSO object created for for Inkling, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Inkling service.

Setup Inkling as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Inkling documentation to set it up as SAML Service Provider.
