...
For example, to configure Inkling, select Inkling and click **Add**.
...
To configure Inkling provide following inputs:
	- **Account ID** : Provide the account Id from the SSO URL. For eg - If the SSO URL is https://api.inkling.com/saml/v2/metadata/abcdefgh12345566, then the account id is abcdefgh12345566
...
#. Select the SAML SSO object created for for Inkling, and click **Export Metadata**.
