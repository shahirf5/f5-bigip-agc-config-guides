...
For example, to configure Jive, select Jive and click **Add**.
...
To configure Jive provide following inputs:
	- **Sub Domain** : Specify Sub Domain value. For example, if the entity ID URL is https://company.jiveon.com, then enter company
...
#. Select the SAML SSO object created for for Jive, and click **Export Metadata**.
