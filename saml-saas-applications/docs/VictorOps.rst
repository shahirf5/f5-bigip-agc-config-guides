...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure VictorOps:
...
VictorOps Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure VictorOps, select VictorOps and click :guilabel:`Add`.
...
To configure VictorOps provide following inputs:
	- :guilabel:`Company ID` : Provide the company ID from the portal URL. For eg - If portal URL is https://portal.victorops.com/auth/sso/testcompany, then company id is testcompany.
...
Refer to VictorOps documentation to set it up as SAML Service Provider.
