======================================================================================
SaaS Application Configuration Guide : New Relic
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure New Relic:
...
New Relic Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure New Relic, select New Relic and click :guilabel:`Add`.
...
To configure New Relic provide following inputs:
	- :guilabel:`Account ID` : Enter your Account ID, for example if your ACS URL is: https://rpm.newrelic.com/accounts/123456/sso/saml/finalize, enter: 123456
...
#. Select the SAML SSO object created for for New Relic, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the New Relic service.

Setup New Relic as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to New Relic documentation to set it up as SAML Service Provider.
