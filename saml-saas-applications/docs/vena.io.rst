=================================================================
SaaS Application Configuration Guide : vena.io
=================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes configuration steps for configuring an AGC SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure vena.io:
...
vena.io Configuration in AGC Workflow
----------------------------------------------
...
vena.io, select
vena.io and click on **Add** button
...
vena.io does not require any user input.
...
#. Identify the Saml SSO object created for for vena.io and export SAML Metadata.

You can use the exported IdP SAML Metadata to configure the IdP Provider configuration in vena.io service.
