======================================================================================
SaaS Application Configuration Guide : Clicksoftware
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Clicksoftware:
...
Clicksoftware Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Clicksoftware, select Clicksoftware and click :guilabel:`Add`.
...
To configure Clicksoftware provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain. For eg - If the SSO URL is https://company.clicksoftware.com/cgi/samlauth, then the sub domain is company.
...
#. Select the SAML SSO object created for for Clicksoftware, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Clicksoftware service.

Setup Clicksoftware as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Clicksoftware documentation to set it up as SAML Service Provider.
