...
For example, to configure VCloud Director, select VCloud Director and click ``Add``.
...
To configure VCloud Director provide following inputs:
	- ``VCloud Director Hostname`` : Provide the Hostname from your SSO url. For eg if URL is https://abcd.com/cloud/org/test/saml/SingleLogout/alias/vcd, then hostname is abcd.com.
	- ``Organization Name`` : Provide the organization name from your SSO url. For eg if URL is https://abcd.com/cloud/org/test/saml/SingleLogout/alias/vcd, then orgnaization name is test.
...
#. Select the SAML SSO object created for for VCloud Director, and click ``Export Metadata``.
