======================================================================================
SaaS Application Configuration Guide : VCloud Director
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure VCloud Director:
...
VCloud Director Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure VCloud Director, select VCloud Director and click :guilabel:`Add`.
...
To configure VCloud Director provide following inputs:
	- :guilabel:`VCloud Director Hostname` : Provide the Hostname from your SSO url. For eg if URL is https://abcd.com/cloud/org/test/saml/SingleLogout/alias/vcd, then hostname is abcd.com.
	- :guilabel:`Organization Name` : Provide the organization name from your SSO url. For eg if URL is https://abcd.com/cloud/org/test/saml/SingleLogout/alias/vcd, then orgnaization name is test.
...
#. Select the SAML SSO object created for for VCloud Director, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the VCloud Director service.

Setup VCloud Director as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to VCloud Director documentation to set it up as SAML Service Provider.
