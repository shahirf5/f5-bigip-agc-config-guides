...
For example, to configure PageUp People, select PageUp People and click ``Add``.
...
To configure PageUp People provide following inputs:
	- ``Data Center Location`` : Select the Data Center location
...
#. Select the SAML SSO object created for for PageUp People, and click ``Export Metadata``.
