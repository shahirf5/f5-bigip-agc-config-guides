======================================================================================
SaaS Application Configuration Guide : Cherwell OnDemand
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure Cherwell OnDemand:
...
Cherwell OnDemand Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure Cherwell OnDemand, select Cherwell OnDemand and click :guilabel:`Add`.
...
To configure Cherwell OnDemand provide following inputs:
	- :guilabel:`Sub Domain` : Enter Sub Domain. For example, if you log into https://yourcompany.cherwellondemand.com, enter: yourcompany
...
#. Select the SAML SSO object created for for Cherwell OnDemand, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Cherwell OnDemand service.

Setup Cherwell OnDemand as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Cherwell OnDemand documentation to set it up as SAML Service Provider.
