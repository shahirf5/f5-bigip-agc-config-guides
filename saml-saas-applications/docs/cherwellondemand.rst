...
For example, to configure Cherwell OnDemand, select Cherwell OnDemand and click **Add**.
...
To configure Cherwell OnDemand provide following inputs:
	- **Sub Domain** : Enter Sub Domain. For example, if you log into https://yourcompany.cherwellondemand.com, enter: yourcompany
...
#. Select the SAML SSO object created for for Cherwell OnDemand, and click **Export Metadata**.
