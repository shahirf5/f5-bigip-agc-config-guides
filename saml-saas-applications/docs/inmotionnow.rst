...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure inmotionnow:
...
inmotionnow Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure inmotionnow, select inmotionnow and click :guilabel:`Add`.
...
To configure inmotionnow provide following inputs:
	- :guilabel:`EntityID` : Provide the entityID
	- :guilabel:`Sub Domain` : Provide the sub domain from the SSO URL. For eg if SSO URL is https://company.inmotionnow.com/saml/post, then the sub domain is company
...
#. Select the SAML SSO object created for for inmotionnow, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the inmotionnow service.

Setup inmotionnow as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to inmotionnow documentation to set it up as SAML Service Provider.
