======================================================================================
SaaS Application Configuration Guide : BenefitFocus
======================================================================================

BIG-IP as SAML IdP Configuration
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure BenefitFocus:
...
BenefitFocus Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure BenefitFocus, select BenefitFocus and click :guilabel:`Add`.
...
To configure BenefitFocus provide following inputs:
	- :guilabel:`Sub Domain` : Enter your Sub Domain. For example, if you log into https://company.benefitfocus.com/sp/ACS.saml2, enter: company
...
#. Select the SAML SSO object created for for BenefitFocus, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the BenefitFocus service.

Setup BenefitFocus as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to BenefitFocus documentation to set it up as SAML Service Provider.
