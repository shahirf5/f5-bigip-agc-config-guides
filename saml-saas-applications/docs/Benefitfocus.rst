...
For example, to configure BenefitFocus, select BenefitFocus and click ``Add``.
...
To configure BenefitFocus provide following inputs:
	- ``Sub Domain`` : Enter your Sub Domain. For example, if you log into https://company.benefitfocus.com/sp/ACS.saml2, enter: company
...
#. Select the SAML SSO object created for for BenefitFocus, and click ``Export Metadata``.
