...
For example, to configure Netdimensions, select Netdimensions and click :guilabel:`Add`.
...
To configure Netdimensions provide following inputs:
	- :guilabel:`Sub Domain` : Provide the sub domain from SSO URL. For eg if the SSO URL is https://company.netdimensions.com/shibboleth-sp, then sub domain is company.
...
#. Select the SAML SSO object created for for Netdimensions, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the Netdimensions service.

Setup Netdimensions as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to Netdimensions documentation to set it up as SAML Service Provider.
