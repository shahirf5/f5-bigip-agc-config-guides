...
--------------------------------
This document describes the configuration for a SAML Identity Provider for SaaS Application workflow using a SaaS Application template. Follow the steps below to configure GitHub Enterprise:
...
GitHub Enterprise Configuration in Guided Configuration Workflow
---------------------------------------------------------------------------------------------------------------------------
...
For example, to configure GitHub Enterprise, select GitHub Enterprise and click :guilabel:`Add`.
...
To configure GitHub Enterprise provide following inputs:
	- :guilabel:`Hostname` : Provide only the hostname which hosts the GitHub Enterprise. For example - test.github.com.
...
#. Select the SAML SSO object created for for GitHub Enterprise, and click :guilabel:`Export Metadata`.
#. Use the exported IdP SAML Metadata to configure the IdP Provider configuration in the GitHub Enterprise service.

Setup GitHub Enterprise as SAML Service Provider
------------------------------------------------------------------------------------------------------------

Refer to GitHub Enterprise documentation to set it up as SAML Service Provider.
