...
For example, to configure GitHub Enterprise, select GitHub Enterprise and click **Add**.
...
To configure GitHub Enterprise provide following inputs:
	- **Hostname** : Provide only the hostname which hosts the GitHub Enterprise. For example - test.github.com.
...
#. Select the SAML SSO object created for for GitHub Enterprise, and click **Export Metadata**.
