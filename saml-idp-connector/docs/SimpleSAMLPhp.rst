...
#. Select the Identity Provider from the provided set. You can search for SimpleSAMLPhp in the Search bar. If a template for your application is not available, you can use the options :guilabel:`Metadata` or :guilabel:`Custom`, and configure the Identity Providers accordingly.

Select SimpleSAMLPhp and click :guilabel:`Add`. Specify a name for the connector.
...
Setup SimpleSAMLPhp as SAML Identity Provider
-----------------------------------------------------------------

Refer to SimpleSAMLPhp documentation to set it up as SAML Identity Provider.
