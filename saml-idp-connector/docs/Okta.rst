...
#. Select the Identity Provider from the provided set. You can search for Okta in the Search bar. If a template for your application is not available, you can use the options *Metadata* or *Custom*, and configure the Identity Providers accordingly.

Select Okta and click **Add**. Specify a name for the connector.
